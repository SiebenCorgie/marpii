...
use iced_marpii_shared::{CmdShape, QuadPush};
use marpii::{
    ash::vk,
...
use crate::batch_cache::BatchCall;
...
pub struct SolidShapePass {
    color_image: ImageHandle,
    depth_image: ImageHandle,

    pipeline: Arc<GraphicsPipeline>,
    pub batches: Vec<BatchCall<CmdShape>>,
...
impl SolidShapePass {
    ...
    pub fn new(
        ...
        let pipeline = Self::solid_shape_pipeline(
            rmg,
