...
use iced::mouse;
use iced::time;
use iced::widget::canvas::{LineCap, Path, Stroke, stroke};
use iced::widget::{canvas, container};
use iced::{Degrees, Element, Fill, Font, Point, Rectangle, Subscription, Theme, Vector};

use iced_marpii::canvas::{Cache, Geometry};

//custom iced renderer
...
impl<Message> canvas::Program<Message, Theme, iced_marpii::Renderer> for Clock {
    type State = ();
